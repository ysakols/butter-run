...
Butter Run is a fitness and running application that provides the following features:

- **GPS-based run tracking** (route, distance, pace)
- **Calorie burn estimation** based on user-provided weight and activity data
- **Cadence and step count tracking** via device motion sensors
...
**THE APP DOES NOT PROVIDE MEDICAL ADVICE.** Nothing in the App — including calorie estimates, pace data, distance calculations, cadence metrics, or any other output — should be construed as medical advice, diagnosis, treatment recommendation, or a substitute for professional medical guidance.

**Before beginning any exercise program, changing your diet, or making any health-related decisions, you must consult with a qualified physician or healthcare provider.** This is especially important if you:

- Have any pre-existing medical condition (including but not limited to heart disease, hypertension, diabetes, asthma, or musculoskeletal conditions)
- Are pregnant or postpartum
- Are taking any medication
- Have a history of injury
- Have not exercised regularly
- Are over the age of 40 and have not recently had a medical examination

**You acknowledge that calorie burn estimates displayed in the App are mathematical approximations based on limited inputs and may be significantly inaccurate. You must not rely on these estimates for dietary planning, weight management, or any health-related purpose without independent verification by a qualified professional.**
...
Your use of the App and participation in any physical activity while using the App is entirely voluntary. You are not required to follow any suggestion, metric, or output provided by the App.

### 5.2 Inherent Risks of Physical Activity

Running, jogging, walking, and other physical activities carry inherent risks of injury, illness, disability, and death. These risks cannot be eliminated regardless of the care taken to avoid them. You knowingly and voluntarily assume all such risks, both known and unknown.

### 5.3 Specific Risks

Without limiting the generality of Section 5.2, you specifically acknowledge and assume the following risks:

1. **Cardiovascular events** — heart attack, stroke, cardiac arrest, arrhythmia, or other cardiovascular incidents during or after exercise
2. **Musculoskeletal injuries** — sprains, strains, fractures, stress fractures, tendonitis, shin splints, plantar fasciitis, or other injuries from running or overtraining
3. **Heat-related illness** — heat exhaustion, heat stroke, dehydration, or hyponatremia
4. **Cold-related illness** — hypothermia, frostbite, or other cold exposure injuries
5. **Falls, collisions, and environmental hazards** — tripping, falling, colliding with objects/persons/vehicles, animal encounters, or hazardous terrain
6. **Gastrointestinal distress** — nausea, vomiting, cramping, or other digestive issues from eating before, during, or after running
7. **Overtraining and overexertion** — fatigue, rhabdomyolysis, overuse injuries, burnout, or exercise addiction, including from pursuing Churn Tracker goals or other gamified targets in the App
8. **Distraction and reduced awareness** — reduced awareness of surroundings, traffic, terrain, weather, or other hazards due to voice feedback, looking at the device screen, or other interaction with the App while running
9. **GPS and metric inaccuracies** — running at unsafe speeds, in unsafe locations, or for unsafe distances due to reliance on App metrics that may be inaccurate
10. **Weight changes** — unintended weight gain or weight loss resulting from reliance on inaccurate calorie burn estimates or App-derived data
11. **Allergic reactions or medical emergencies** — any medical event occurring during exercise
12. **Aggravation of pre-existing conditions** — worsening of known or unknown medical conditions through exercise
13. **Night running and low-visibility conditions** — risks from reduced visibility during dawn, dusk, or nighttime running
14. **Traffic and road hazards** — risks from running on or near roadways, intersections, or areas with vehicular traffic
15. **Weather conditions** — risks from running in rain, snow, ice, wind, extreme heat, extreme cold, storms, or other adverse weather
16. **Battery depletion** — loss of navigation, communication, or emergency services access if the device battery is depleted during a run
17. **Solo running** — additional risks when running alone in remote, unfamiliar, or isolated areas
18. **Wearable device data** — risks from reliance on third-party wearable devices (Apple Watch, heart rate monitors, etc.) that may provide inaccurate data

### 5.4 No Safety Guarantee

The App does not monitor your physical condition, heart rate (unless via third-party wearable integration), hydration, or safety in any way. The App will not warn you if you are overexerting, dehydrated, injured, or in danger. **You are solely responsible for monitoring your own physical condition and safety at all times.**

## 6. Prohibited Uses

You agree that you will NOT use the App:

- While operating a motor vehicle, bicycle, or any other vehicle or machinery
- In any manner that violates applicable law
- While impaired by alcohol, drugs, or medication
- In any location where use of a mobile device is prohibited or unsafe
- To provide medical advice or health recommendations to others
- In any manner that could endanger yourself or others

## 7. Release, Waiver, and Covenant Not to Sue

### 7.1 Release

**TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, YOU HEREBY RELEASE, WAIVE, DISCHARGE, AND COVENANT NOT TO SUE** the Developer, and their officers, directors, employees, agents, affiliates, successors, and assigns (collectively, "Released Parties") from any and all liability, claims, demands, actions, causes of action, suits, costs, expenses (including attorneys' fees), damages, and judgments of every kind and nature, whether known or unknown, suspected or unsuspected, both in law and equity, that you have, have ever had, or may in the future have, arising out of or relating in any way to:

1. Your use of or inability to use the App
2. Any physical activity undertaken in connection with the App
3. Any injury, illness, disability, death, or property damage resulting from your use of the App or reliance on any App output
4. Any inaccuracy in distance, pace, calorie burn, cadence, step count, or any other metric provided by the App
5. Gastrointestinal distress or digestive issues related to eating before, during, or after exercise
6. Weight gain, weight loss, or body composition changes resulting from reliance on App data
7. Distraction, reduced awareness, or impaired judgment caused by voice feedback, screen interaction, or any other App feature
8. Overexertion or overtraining, including that motivated by Churn Tracker goals or other gamified elements
9. Inaccurate GPS data leading to unsafe running routes, speeds, or distances
10. Aggravation of pre-existing medical conditions through exercise
...
**YOU EXPRESSLY WAIVE ANY RIGHTS YOU MAY HAVE UNDER CALIFORNIA CIVIL CODE SECTION 1542** (or any similar statute in any jurisdiction), which provides:
